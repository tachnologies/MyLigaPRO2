package com.tachnologies.myligapro.moduloAdm.jugadoresAdm.adapters;
...
public class JugadorAdmAdapter extends RecyclerView.Adapter<JugadorAdmAdapter.ViewHolder>{
    private List<Jugador> jugadores;
    private OnItemClickListener listener;
    private Context context;

    public JugadorAdmAdapter(List<Jugador> jugadores, OnItemClickListener listener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new JugadorAdmAdapter.ViewHolder(view);
    }
