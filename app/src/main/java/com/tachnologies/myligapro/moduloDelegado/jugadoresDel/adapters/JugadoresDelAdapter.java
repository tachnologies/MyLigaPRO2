package com.tachnologies.myligapro.moduloDelegado.jugadoresDel.adapters;
...
public class JugadoresDelAdapter extends RecyclerView.Adapter<JugadoresDelAdapter.ViewHolder>{
    private List<Jugador> jugadores;
    private OnItemClickListener listener;
    private Context context;

    public JugadoresDelAdapter(List<Jugador> jugadores, OnItemClickListener listener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new JugadoresDelAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvData.setText(
                context.getString(
                        R.string.common_doble_parametro_string, item.getNombre(),
                        item.getApellido()));
